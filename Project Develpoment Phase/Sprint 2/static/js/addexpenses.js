...
function addRow() {
    ...
    newRow += "</select></td><td><input type='number' class='form-control-sm' name='amount.' form='expenseForm' size='10' placeholder='₹' maxlength='10' required title='Format must be currency value without rupees sign or commas e.g. 1, 2.50, 1500.75'></td></tr>"
